...
<body>
    ...
    <div class="navbar">
        ...
        <div>
            <h3 class="cart-title" style="text-align:center !important">Your Cart</h3>
        </div>
    </div>
    ...
    <div class="cart-items-container">
        ...
        <div class="footer d-flex flex-column justify-content-end align-items-center">
            ...
            <div class="total-price-container py-2">
                ...
                <button type="button" class="btn btn-success place-order-btn" style="font-weight: bold;"> Place Order <i class="fa-solid fa-cart-arrow-down fa-fade"></i></button>
            </div>
